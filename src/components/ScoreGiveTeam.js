...
const ScoreGiveTeam = props =>
  ...
  <div className="give-team-score-container">
    ...
    <div>
      ...
      <span> 3PM: { (props.playerStatDiff[1][2] - props.playerStatDiff[0][2]).toFixed(2) }</span>,
      <span> FG%: { (props.playerStatDiff[1][3] - props.playerStatDiff[0][3]).toFixed(2) }</span>,
      <span> FT%: { (props.playerStatDiff[1][4] - props.playerStatDiff[0][4]).toFixed(2) }</span>,
      <span> Blk: { (props.playerStatDiff[1][5] - props.playerStatDiff[0][5]).toFixed(2) }</span>,
      <span> Stl: { (props.playerStatDiff[1][6] - props.playerStatDiff[0][6]).toFixed(2) }</span>
    </div>
  </div>;
